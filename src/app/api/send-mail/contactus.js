export const getContactusHtml = (name, text, email, company) => {
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div style="background-color: #f4f4f4; padding: 20px;">
        <div class="container" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; font-family: Arial, sans-serif;">
            ...
            <div class="header" style="background-color: #0070f3; color: #ffffff; padding: 30px; text-align: center;">
                ...
                <p style="margin: 10px 0 0; opacity: 0.9;">We have received an inquiry</p>
            </div>
                ...
                <div style="margin-top: 20px; border: 1px solid #eee; border-radius: 8px; padding: 10px;">
                    <table class="info-table" style="width: 100%; border-collapse: collapse;">
                        <tbody>
                            ...
                            <tr>
                                <td class="info-label" style="padding: 10px; font-weight: bold; color: #555; vertical-align: top;">Company:</td>
                                <td class="info-value" style="padding: 10px; color: #333;">${company}</td>
                            </tr>
