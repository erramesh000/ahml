...
export default function About() {
    return (
        <>
            <Head>
                <title>About Advanced Healing Massage Ltd | Registered Massage Therapist Calgary</title>
                <meta
                    name="description"
                    content="Learn more about Advanced Healing Massage Ltd in Calgary AB, our philosophy of care, and how our registered massage therapists support relaxation, pain relief, and long-term wellness."
                />
